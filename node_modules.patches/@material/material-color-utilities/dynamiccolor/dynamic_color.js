/*
    Deliberately adjusted as causes problems for weback4 used by @skpm/builder because it uses the ? and ?? operators.
 */
...
export class DynamicColor {
    ...
    static fromPalette(args) {
        ...
        let isBackground
        if (is_falsey(args.isBackground))
        {
            isBackground = false
        }
        else
        ...
        return new DynamicColor(name, args.palette, args.tone, isBackground, args.background, args.secondBackground, args.contrastCurve, args.toneDeltaPair);
    }
    /**
