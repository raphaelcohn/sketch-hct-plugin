...
import {ContrastLevel, ContrastLevelToTone} from "../../contrast";
...
export class SurfaceSwatch extends AbstractSwatch
{
	...
	public tone(this: NonNullable<this>, theme_mode: ThemeMode, _variant: Variant, _palettes: NonNullable<CorePalettes>, _source_color: NonNullable<HueChromaToneCoordinates>, contrast_level: ContrastLevel): NonNullable<Tone>
	{
		return this.#tones.choose(theme_mode).contrast_ratio_for_level(contrast_level)
	}
}
