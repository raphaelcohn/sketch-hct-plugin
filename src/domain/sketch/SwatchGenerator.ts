...
import {SwatchPaletteName} from "../theme/SwatchPaletteName";
import {Scheme} from "../scheme";
import {ThemeMode} from "../scheme/ThemeMode";
import {AbstractScheme} from "../theme/AbstractScheme";
import {CustomColorColors} from "../theme/CustomColorColors";
import {AddSwatch} from "../theme/AddSwatch";
import {SRgbCoordinates} from "../color_space/srgb";

type SchemeKey = keyof typeof Scheme;

const enum Hierarchy
{
	Source = "Source",
...
export class SwatchGenerator
{
	...
	public generate(this: NonNullable<this>)
	{
