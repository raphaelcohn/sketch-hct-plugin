...
export class InclusiveMinimumNoMaximumRange implements Range
{
	public static readonly ZeroToInfinity: InclusiveMinimumNoMaximumRange = new InclusiveMinimumNoMaximumRange(FiniteNumber.Zero)
	
	public static readonly OneToInfinity: InclusiveMinimumNoMaximumRange = new InclusiveMinimumNoMaximumRange(FiniteNumber.One)
