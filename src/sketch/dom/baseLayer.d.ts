...
declare module 'sketch/dom'
{
	namespace dom
	{
		...
		{
			/**
			 * The rotation of the Layer in degrees, clockwise.
			 */
			rotation: number
		...
		export abstract class Layer<NativeType = any> extends Component<NativeType>
		{
			/**
		...
		class StyledLayer<NativeType> extends Layer<NativeType>
		{
			/**
