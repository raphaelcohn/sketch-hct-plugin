...
export default function compile(folders: Folders, working_directory: AbsoluteFolderPath, package_json: PackageJson, ...typescript_arguments: string[]): string
{
	...
	return x(folders, working_directory, options, "typescript", package_json, "tsc", ...typescript_arguments)
}
