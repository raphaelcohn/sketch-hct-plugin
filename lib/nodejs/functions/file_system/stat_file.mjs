...
{
	assert.is_zero_or_positive_bigint(mode)
	assert.is_zero_or_positive_bigint(bit)
...
function is_mode_x(stat, user_bit, group_bit, other_bit)
{
	...
	assert.is_zero_or_positive_bigint(user_bit)
	assert.is_zero_or_positive_bigint(group_bit)
	assert.is_zero_or_positive_bigint(other_bit)
