...
import {assert_is_non_empty_string, assert_is_string, assert_is_string_array} from "./assert.mjs";
import {join} from "node:path";
import {symlinkSync} from "node:fs";

export function symlink(path_value, ...write_to_file_path_components)
{
	assert_is_non_empty_string(path_value)
	assert_is_string_array(write_to_file_path_components)
